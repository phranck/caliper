...
**A measurement is either physical or spatial, and the two do not scale alike.** A fingertip is 9 mm wherever it is. On an 800 by 480 panel across five inches that is 66 points, because the panel carries 7.35 pixels per millimeter. On a 1024 by 600 panel across seven inches the density is lower and the same fingertip is 60 points, whilst a factor taken from the width would say 84. Caliper takes a description of the panel and converts millimeters and reading distances through its density, so a fingertip stays a fingertip and a body text stays readable from 40 cm.
